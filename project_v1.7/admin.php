...
<head>
    ...
    <title>Admin - Band Website v1.7</title>
    <link rel="stylesheet" href="CSS/style.css">
</head>
<body>
    <div class="container">
        <header>
            <h1>Band Website v1.7 - Panel Administracyjny</h1>
            <nav>
        ...
        <main>
            <!-- Tutaj zawartość panelu admina -->
            <h2>Witaj w panelu administracyjnym</h2>
            <p>Wersja systemu: 1.7</p>
        </main>

        <footer>
            <p>&copy; <?php echo date('Y'); ?> Band Website. Wersja 1.7</p>
        </footer>
    </div>
</body>
</html>
